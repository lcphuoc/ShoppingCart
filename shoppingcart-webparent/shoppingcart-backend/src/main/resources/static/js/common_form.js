$(document).ready(function () {
	...
	$(".fileImage").change(function () {
		...
		showImageThumbnail(this,userId);
	});
});
...
function showImageThumbnail(fileInput,id) {
	...
	reader.onload = function (e) {
		$("#thumbnail"+id).attr("src", e.target.result);//gán giá trị của e.target.result vào thuộc tính src -->đây là cách thay đổi hình khi chọn file hình mới
	};
